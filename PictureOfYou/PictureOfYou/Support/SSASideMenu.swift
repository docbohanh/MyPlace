...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    struct ContentViewEffect {
        ...
        var interactivePopGestureRecognizerEnabled: Bool = false
        
        init(alpha: Float = 1.0, scale: Float = 0.7, landscapeOffsetX: Float = 30, portraitOffsetX: Float = 30, minParallaxContentRelativeValue: Float = -25.0, maxParallaxContentRelativeValue: Float = 25.0, interactivePopGestureRecognizerEnabled: Bool = false) {
    ...
    @IBInspectable fileprivate var fadeMenuView: Bool =  true
    @IBInspectable fileprivate var scaleMenuView: Bool = true
    @IBInspectable fileprivate var scaleBackgroundImageView: Bool = true
    @IBInspectable fileprivate var parallaxEnabled: Bool = true
    @IBInspectable fileprivate var bouncesHorizontally: Bool = true
    ...
    @IBInspectable fileprivate var contentViewScaleValue: Float = 0.7
    @IBInspectable fileprivate var contentViewFadeOutAlpha: Float = 1.0
    @IBInspectable fileprivate var contentViewInLandscapeOffsetCenterX: Float = 30.0
    @IBInspectable fileprivate var contentViewInPortraitOffsetCenterX: Float = 30.0
    @IBInspectable fileprivate var parallaxContentMinimumRelativeValue: Float = -25.0
    @IBInspectable fileprivate var parallaxContentMaximumRelativeValue: Float = 25.0
    
    // MARK : Public Properties: ContentView
    @IBInspectable var interactivePopGestureRecognizerEnabled: Bool = false
    @IBInspectable var endAllEditing: Bool = false
    
    // MARK : Private Properties: Shadow for ContentView
    @IBInspectable fileprivate var contentViewShadowEnabled: Bool = true
    @IBInspectable fileprivate var contentViewShadowColor: UIColor = UIColor.black
    @IBInspectable fileprivate var contentViewShadowOffset: CGSize = CGSize.zero
    @IBInspectable fileprivate var contentViewShadowOpacity: Float = 0.4
    @IBInspectable fileprivate var contentViewShadowRadius: Float = 8.0
    ...
    fileprivate func animateMenuViewController(_ side: SSASideMenuSide) {
        ...
        if scaleBackgroundImageView && backgroundImage != nil {
    ...
    func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        if interactivePopGestureRecognizerEnabled,
            ...
            , viewController.viewControllers.count > 1,
            let popGesture = viewController.interactivePopGestureRecognizer
            , popGesture.isEnabled {
            return false
        }
